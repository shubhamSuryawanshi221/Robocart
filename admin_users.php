...
<body>
    <div class="sidebar">
        <a href="order_management.php"><i class="fas fa-tasks"></i> Order Management</a>
        <a href="manage_users.php"><i class="fas fa-users"></i> Manage Users</a>
        <a href="create_category.php"><i class="fas fa-folder-plus"></i> Create Category</a>
        <a href="sub_category.php"><i class="fas fa-folder"></i> Sub Category</a>
        ...
        <a href="user_login.php"><i class="fas fa-sign-in-alt"></i> User Login</a>
